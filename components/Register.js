        ...
        <View style={styles.container}>
            <View style={styles.viewMiddle}>
                ...
                <View>
                    ...
                    <TextInput placeholder={"비밀번호"} style={styles.form} autoCapitalize={"none"} autoCorrect={false} returnKeyType={"next"}/>
                </View>
                <View>
                ...
                <View>
                    ...
                    <TextInput placeholder={"비밀번호 찾기 시 필요합니다"} style={styles.form} autoCapitalize={"none"} autoCorrect={false} returnKeyType={"next"}/>
                </View>
                <Pressable
                    onPress={() => navigation.navigate("Time Card Login Page")}
                    style={styles.button}>
